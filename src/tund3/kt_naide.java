...
Koosta klass arvuliste väärtuste hoidmiseks. Lisa funktsioonid suurima, vähima ja aritmeetilise keskmise massi väärtuse leidmiseks.
Koosta toString()-käsklus nende andmete väljastamiseks. Loe eelnevast failist koerte ja kasside andmed klassi eraldi eksemplaridesse.
Salvesta eksemplaride toString()-käskluste väljundid faili. */


public class kt_naide {
}
